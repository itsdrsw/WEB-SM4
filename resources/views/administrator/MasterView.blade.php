                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <p class="mb-0 text-muted"><i
                                                            class="mdi mdi-arrow-up-bold text-success"></i> 45% This
                                                        Week</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <p class="mb-0 text-muted"><i
                                                            class="mdi mdi-arrow-up-bold text-success"></i> 32% This
                                                        Week</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <h4 class="mt-0 mb-1 font-20">$12,500</h4>
                                                    <p class="mb-0 text-muted"><i
                                                            class="mdi mdi-arrow-up-bold text-success"></i> 60% This
                                                        Week</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="tab-content" id="pills-tabContent">
                                                <div class="tab-pane fade show active" id="day-status" role="tabpanel"
                                                    ...
                                                    <div dir="ltr">
                                                        <div id="day-balance-chart" class="apex-charts"
                                                ...
                                                <div class="tab-pane fade" id="week-status" role="tabpanel"
                                                    ...
                                                    <div dir="ltr">
                                                        <div id="week-balance-chart" class="apex-charts"
                                                            data-colors="#0acf97"></div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane fade" id="month-status" role="tabpanel"
                                                    ...
                                                    <div dir="ltr">
                                                        <div id="month-balance-chart" class="apex-charts"
                                                            data-colors="#0acf97"></div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane fade" id="year-status" role="tabpanel"
                                                    ...
                                                    <div dir="ltr">
                                                        <div id="year-balance-chart" class="apex-charts"
                                                            data-colors="#0acf97"></div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body pt-0 mb-2" data-simplebar style="max-height: 319px;">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <p class="mb-0 text-success"><i class="mdi mdi-trending-up me-1"></i>10%
                                                </p>
                                            </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <p class="mb-0 text-danger"><i
                                                        class="mdi mdi-trending-down me-1"></i>12%</p>
                                            </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <p class="mb-0 text-success"><i class="mdi mdi-trending-up me-1"></i>15%
                                                </p>
                                            </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <p class="mb-0 text-success"><i class="mdi mdi-trending-up me-1"></i>11%
                                                </p>
                                            </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    <h4 class="mt-0 mb-1 font-16 fw-semibold">Kazakhstani tenge (KZT)
                                                    </h4>
                                                    <p class="mb-0 text-muted">$0.0023</p>
                                                </div>
                                                <p class="mb-0 text-danger"><i
                                                        class="mdi mdi-trending-down me-1"></i>10%</p>
                                            </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <p class="mb-0 text-success"><i class="mdi mdi-trending-up me-1"></i>18%
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table table-centered table-nowrap table-hover mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="badge bg-success-lighten text-success">Incoming</span>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-end">
                                                        <a href="javascript:void(0);" class="font-18 text-info me-2"
                                                            ...
                                                            title="Edit"><i class="uil uil-pen"></i></a>
                                                        <a href="javascript:void(0);" class="font-18 text-danger"
                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                                            title="Delete"><i class="uil uil-trash"></i></a>
                                                    </td>
                                                </tr> <!-- end tr -->
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="badge bg-danger-lighten text-danger">Outgoing</span>
                                                    </td>
                                                    <td>
