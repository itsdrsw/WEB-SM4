                ...
                <form class="needs-validation" novalidate action="/register" method="POST">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                            placeholder="Masukkan Nama UKM" value="{{ old('name') }}" required>
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="ketua" class="form-control @error('ketua') is-invalid @enderror"
                            placeholder="Masukkan Nama Anda " value="{{ old('ketua') }}" required>
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    <div class="row d-flex justify-content-center">
                        <a href="/login" class="mt-2 text-center">I already have a account</a>
                    </div>
                </form>
            </div>
