...
<head>
    ...
    <title>@yield('title') | SIK-MAS POLIJE</title>
    ...
    <div class="wrapper">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" data-widget="pushmenu" href="#" role="button"><i
                            class="fas fa-bars-progress"></i></a>
                </li>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="/dashboard" class="brand-link">
                ...
                <span class="brand-text font-weight-light">SIK-MAS POLIJE</span>
            </a>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2024 <a href="https://github.com/itsdrsw">SAE Team</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
