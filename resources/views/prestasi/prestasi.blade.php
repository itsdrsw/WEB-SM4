                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="text-left">
                                <a href="#" class="btn btn-primary btn-custom"><i class="fa-solid fa-trophy"></i>
                                </a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                                ...
                                <tbody>
                                    @foreach ($prestasi as $dataprestasi)
                                        <tr>
                                                            ...
                                                            <div class="modal-body">
                                                                <table
                                                                    ...
                                                                    <tbody style="pointer-events: none;">
                                                                        ...
                                                                        <tr>
                                                                            <th scope="row" class="text-left">Catatan
                                                                            </th>
                                                                            <td class="text-left">:
                                                                                {{ $dataprestasi->note }}
                                                                            </td>
                                            ...
                                            <td>
                                                <form class="d-inline"
                                                    action="/prestasi/{{ $dataprestasi->idprestasi }}/edit" method="GET">
                                                    <button type="submit" class="btn btn-warning btn-sm mr-1">
                                                        <i class="fa-solid fa-square-pen"></i> Konfirmasi
                                                    </button>
                                                </form>
                                                <form id="delete-form-{{ $dataprestasi->idprestasi }}" class="d-inline"
                                                    action="/prestasi/{{ $dataprestasi->idprestasi }}" method="POST">
                                                    @csrf
                                                    @method('delete')
                                                    <button type="button" class="btn btn-danger btn-sm"
                                                        onclick="confirmDelete({{ $dataprestasi->idprestasi }})">
